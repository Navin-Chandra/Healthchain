...
export class DataService<Type> {
    ...
    /**Added for login alone */
    public getLogin(ns: string, id1: string, id2: string): Observable<Type> {
        console.log('GetSingle ' + ns);
         let myParams = new URLSearchParams();
         myParams.append('partiId', id1);
         myParams.append('password', id2);
           return this.http.get(this.actionUrl+ ns +'?'+ myParams)
           .map(this.extractData)
           .catch(this.handleError);
     }
