...
import { participantLoginComponent } from './participantLogin.component';
import {participantLoginService} from './participantLogin.service';
...
providers: [participantLoginService,DataService,Configuration]
    })
    .compileComponents();
  }));
